...
FIELDS_DICT = {
    ...
    'additional_fields': {
        'mcv': {'type': 'number', 'label': 'MCV', 'unit': 'фл', 'default': 89, 'step': 1,},
        'mchc': {'type': 'number', 'label': 'MCHC', 'unit': 'г/л', 'default': 330, 'step': 1,},
        'rdw': {'type': 'number', 'label': 'RDW', 'unit': '%', 'default': 12, 'step': 1,},
        'rdv_sd': {'type': 'number', 'label': 'RDW-SD', 'unit': 'фл', 'default': 45, 'step': 1,},
        'ret_abs': {'type': 'number', 'label': 'MCHC', 'unit': '×10⁹/л', 'default': 30, 'step': 0.1,},

        'ne_abs': {'type': 'number', 'label': 'Нейтрофилы', 'unit': '×10⁹/л', 'default': 3.5, 'step': 0.1,},
        'pal': {'type': 'number', 'label': 'Палочкоядерные', 'unit': '%', 'default': 3, 'step': 1,},
        'seg': {'type': 'number', 'label': 'Сегментоядерные', 'unit': '%', 'default': 57, 'step': 1,},
        'ly_abs': {'type': 'number', 'label': 'Лимфоциты', 'unit': '×10⁹/л', 'default': 3.5, 'step': 0.1,},
        'mo_abs': {'type': 'number', 'label': 'Моноциты', 'unit': '×10⁹/л', 'default': 0.5, 'step': 0.1,},
        'eo_abs': {'type': 'number', 'label': 'Эозинофилы', 'unit': '×10⁹/л', 'default': 0.3, 'step': 0.1,},
        'ba_abs': {'type': 'number', 'label': 'Базофилы', 'unit': '×10⁹/л', 'default': 0.3, 'step': 0.1,},
        'mxd_abs': {'type': 'number', 'label': 'Смеш. фракция', 'unit': '×10⁹/л', 'default': 0.3, 'step': 0.1,},

        'mpv': {'type': 'number', 'label': 'MPV', 'unit': 'фл', 'default': 7.5, 'step': 0.1,},
        'pdw': {'type': 'number', 'label': 'PDW', 'unit': '%', 'default': 10, 'step': 1,},
        
        'plasma': {'type': 'checkbox', 'label': 'Плазматические клетки', 'value': 1,'default': False},
        'plcr': {'type': 'number', 'label': 'P-LCR', 'unit': '%', 'default': 20, 'step': 1,},
        ...
        'normobl_abs': {'type': 'number', 'label': 'Нормобласты абс.', 'unit': '%', 'default': 0.3, 'step': 0.1,},
